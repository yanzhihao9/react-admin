...
import { RootContext } from "./MySqlParser";
...
import { MultOperatorContext } from "./MySqlParser";
import { AddOperatorContext } from "./MySqlParser";
 ...
 * `MySqlParser`.
 */
export default class MySqlParserListener extends ParseTreeListener {
	/**
